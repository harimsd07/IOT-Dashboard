...
<div id="sidebar" class="sidebar">
    ...
    <div class="sidebar-wrapper flex-wrap flex-column">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('user-view-devices',['id' => Auth::user()->id]) }}">
                    <i class="material-icons">devices</i>
                    <span class="sidebar-text">Devices</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('user-change-password',['id' => Auth::user()->id]) }}">
                    <i class="material-icons">lock</i>
                    <span class="sidebar-text">ChangePassword</span>
                </a>
            </li>
